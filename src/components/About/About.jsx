			...
			<Grid columns={2}>
				...
				<Grid.Row>
					...
					<Grid.Column style={{ width: "70%" }}>
						...
						<Image src="https://i.imgur.com/5feNx95.png" alt="amazon-web-services-certification-image" size="tiny" style={{ float: "left", marginRight: "3vh" }} />
						<p>Earned Amazon Web Services Cloud Practitioner in December 2022.
							<br></br>
