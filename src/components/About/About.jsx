...
export default function About() {
	return (
		<>
			<div>
				<div >
					<a name="about-anchor"><h2>About</h2></a>
					<p>I am an LA based Full-stack Web Developer who has spent the last two years growing my knowledge base by following my curiosity.</p>
			...
			<div>
				<img src="https://i.imgur.com/KG96xW4.png" alt="sophie-headshot" id="headshot" />
			</div>
		</>
	)
}