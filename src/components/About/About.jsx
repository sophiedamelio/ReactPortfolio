		...
		<div id="aboutSection">
			...
			<Grid columns={2}>
				...
				<Grid.Row verticalAlign={"middle"}>
					<Grid.Column style={{ width: "10%", display: "flex" }} >
						<Image src="https://i.imgur.com/hN7GAid.png" alt="general-assembly-logo" size="tiny" />
					</Grid.Column>
				...
				<Grid.Row verticalAlign={"middle"} style={{ marginTop: "3vh", marginBottom: "3vh" }}>
					<Grid.Column style={{ width: "10%", display: "flex" }}>
