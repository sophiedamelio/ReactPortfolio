		...
		<div id="aboutSection">
			...
			<Grid columns={2}>
				<Grid.Row verticalAlign={"middle"}>
					<Grid.Column style={{ width: "30%", display: "flex", alignItems: "center" }} >
						<Image src="https://i.imgur.com/hN7GAid.png" alt="general-assembly-logo" size="tiny" centered="true" />
				...
				<Grid.Row verticalAlign={"middle"}>
					<Grid.Column style={{ width: "30%", display: "flex", alignItems: "center" }}>
						<Image src="https://i.imgur.com/5feNx95.png" alt="amazon-web-services-certification-image" size="tiny" centered="true" />
